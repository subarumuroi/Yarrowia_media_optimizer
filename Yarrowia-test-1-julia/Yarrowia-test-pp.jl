...
fname_concs = "./Yarrowia-test-1-julia/Yarrowia_gp_test_1_999.xlsx"

# Input deck layouts. The only difference is purpose == 3 for 24/96 well position
fname_24 = "./Yarrowia-test-1-julia/deck-yarrow-pretest-24-well.csv"
fname_96 = "./Yarrowia-test-1-julia/deck-yarrow-pretest-96-well.csv"

# Output files names

fname_pipette  = "./Yarrowia-test-1-julia/yarrowia-test-conc-volume-matrix999.csv"
fname_part1    = "./Yarrowia-test-1-julia/yarrowia-pretest-flowbot-part-1-pooled.csv"
fname_part2_24 = "./Yarrowia-test-1-julia/yarrowia-pretest-flowbot-part-2-24well.csv"
fname_part2_96 = "./Yarrowia-test-1-julia/yarrowia-pretest-flowbot-part-2-96well.csv"
fname_deck_24  = "./Yarrowia-test-1-julia/yarrowia-pretest-flowbot-deck-tube-layout-24well.xlsx"
fname_deck_96  = "./Yarrowia-test-1-julia/yarrowia-pretest-flowbot-deck-tube-layout-96well.xlsx"
